...
drop table if exists common.apps;
...
drop table if exists common.app_funcs;
...
drop table if exists common.app_versions;
...
drop table if exists common.group_app_funcs;
...
drop table if exists common.group_app_funcs_history;
